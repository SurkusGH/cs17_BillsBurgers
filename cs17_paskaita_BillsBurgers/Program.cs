...
namespace cs17_paskaita_BillsBurgers
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            #endregion
            var burger = new Hamburger("Simpleton", "Beef", "Default", 10d);
            burger.AddHamburgerAddition1("Letuce", 1d);
            burger.AddHamburgerAddition2("Tomato", 1d);
            burger.AddHamburgerAddition3("Carrot", 1d);
            burger.AddHamburgerAddition4("Potato", 1d);

            burger.ItemizeHamburger();

            #region EXAMPLE I/O: HealthyBurger
            //Example input:
            ...
            var healthyBurger = new HealthyBurger("Chicken", 10d);
            healthyBurger.AddHealthyAddition1("Letuce", 1d);
            healthyBurger.AddHealthyAddition2("Tomato", 1d);
            healthyBurger.ItemizeHamburger();

            #region EXAMPLE INPUT: DeluxeBurger
            //Example input:
            ...
            deluxeBurger.AddChips("Chips", 2d);
            deluxeBurger.AddChips("Coke", 2d);
            deluxeBurger.AddHamburgerAddition1("Letuce", 1d);
            deluxeBurger.AddHamburgerAddition2("Tomato", 1d);
            deluxeBurger.AddHamburgerAddition3("Carrot", 1d);
            deluxeBurger.AddHamburgerAddition4("Potato", 1d);
